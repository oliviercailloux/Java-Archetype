...
image:https://travis-ci.com/oliviercailloux/java-se-1.8-archetype.svg?branch=master["Build Status", link="https://travis-ci.com/oliviercailloux/java-se-1.8-archetype"]
...
A maven https://maven.apache.org/guides/introduction/introduction-to-archetypes.html[archetype] for quickly starting Java SE 8 projects.
